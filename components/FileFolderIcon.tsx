...
const FileFolderIcon = (props: FileFolderIconProps) => {
    ...
    return (
        <div ref={iconRef} className={`flex flex-col items-center h-[55px] ${focused ? "invert" : ""}`} onClick={handleOnClick}>
            <img src={`/images/${props.iconPath}`} className='w-[55px] mb-[1px] h-[55px] ' />
